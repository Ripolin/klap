...
*/}}
{{- define "klap.resourceName" -}}
{{- $fullname := include "klap.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "klap.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "klap.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
